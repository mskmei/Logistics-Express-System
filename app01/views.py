...
def depaheatmap(request):
    ...
    file_path = r"D:\lesson\2+\database\finalwork\物流公司系统\物流公司系统\templates\depaheatmap.html"
...
def destheatmap(request):
    ...
    file_path = r"D:\lesson\2+\database\finalwork\物流公司系统\物流公司系统\destheatmap.html"
    map_osm.save(file_path)
